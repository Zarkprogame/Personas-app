    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('paises.update', ['pais' => $pais->pais_codi]) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id" aria-describedby="codigoHelp" disabled="disabled" name="id" value="{{ $pais->pais_codi }}">
                <div id="codigoHelp" class="form-text">Country Id</div>
            </div>

            <div class="mb-3">
                <label for="name" class="form-label">Country</label>
                <input type="text" required class="form-control" id="name" name="name" placeholder="Country name" value="{{ $pais->pais_nomb }}">
            </div>
